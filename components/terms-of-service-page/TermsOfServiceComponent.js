...
const TermsOfServiceComponent = () => {
    return (
        <>
            <Row className={'!py-10 max-w-screen-lg mx-auto'}>
                <Col span={24}>
                    <Title className={'sm:!text-[60px] !mb-0'}>Terms and Conditions</Title>
                </Col>
                <Col span={24}>
                    <Title level={5}>
                        <i className={'text-slate-500'}>- Last updated: March 15, 2023</i>
                    </Title>
                </Col>
                <Col>
                    <Typography level={4}>
                ...
                <Col span={24}>
                    <Title level={2}>Interpretation</Title>
                </Col>
                <Col span={24}>
                ...
                <Col span={24}>
                    <Title level={2}>Definitions</Title>
                </Col>
                <Row className={'ml-7'}>
                    <Col span={24}>
                        <Typography className={'!text-base'}>
                            ...
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>Affiliate</span> means an entity that
                            ...
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>Country refers to:</span> New York, United
                                States
                            </p>
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>Company</span> (referred to as either
                                &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this
                                Agreement) refers to NoshQuad, 3831 Grove Street, NY.
                            </p>
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>Device</span> means any device that can access
                                the Service such as a computer, a cellphone or a digital tablet.
                            </p>
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>Service</span> refers to the Website.
                            </p>
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}> Terms and Conditions</span> (also referred as
                            ...
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>Third-party Social Media Service </span>
                            ...
                            <p className={'!text-base !mt-0'}>
                                ...
                                refers to NoshQuad, accessible from{' '}
                                <Link href={'https://noshquad.com'} as={'https://noshquad.com'}>
                                    <a>https://noshquad.com/</a>
                                </Link>{' '}
                            </p>
                            <p className={'!text-base !mt-0'}>
                                <span className={'text-xl font-semibold'}>You </span> means the individual accessing or
                    ...
                    <Col span={24}>
                        <Title level={4}>Acknowledgment</Title>
                    </Col>
                    <Col span={24}>
                        <Typography>
                            <p className={'!text-base !mt-0'}>
                    ...
                    <Col span={24}>
                        <Title level={4}>Links to Other Websites</Title>
                    </Col>
                    <Col span={24}>
                        <Typography>
                            <p className={'!text-base !mt-0'}>
                    ...
                    <Col span={24}>
                        <Title level={4}>Disputes Resolution</Title>
                    </Col>
                    <Col span={24}>
                        <Typography>
                            <p className={'!text-base !mt-0'}>
                    ...
                    <Col span={24}>
                        <Title level={4}>For European Union (EU) Users</Title>
                    </Col>
                    <Col span={24}>
                        <Typography>
                            <p className={'!text-base !mt-0'}>
                    ...
                    <Col span={24}>
                        <Title level={4}>United States Legal Compliance</Title>
                    </Col>
                    <Col span={24}>
                        <Typography>
                            <p className={'!text-base !mt-0'}>
                ...
                <Col span={24}>
                    <Title level={4}>Translation Interpretation</Title>
                </Col>
                <Col span={24}>
                    <Typography>
                        <p className={'!text-base !mt-0'}>
                ...
                <Col span={24}>
                    <Title level={4}>Changes to These Terms and Conditions</Title>
                </Col>
                <Col span={24}>
                    <Typography>
                        <p className={'!text-base !mt-0'}>
                ...
                <Col span={24}>
                    <Typography>
                        ...
                        <p className={'!text-base !mt-0'}>By email: contact@noshquad.com</p>
                        <p className={'!text-base !mt-0'}>
                            By visiting this page on our website:{' '}
                            <Link href={'https://noshquad.com/contact-us'} as={'https://noshquad.com/contact-us'}>
                                <a>https://noshquad.com/contact-us</a>
                            </Link>{' '}
                        </p>
                    </Typography>
                </Col>
